            ...
            <Row>
                <Col sm={6} className="mx-auto">
                    {loadingPage ? <Loading /> : <Form onSubmit={handleSubmit}>
                        ...
                        <FormItem title="choices" label="choicesId" >
                            <Form.Select name="choicesId" id="choicesId" defaultValue={form.choicesId} onChange={ev => setInForm(ev,form, setForm)} required>
